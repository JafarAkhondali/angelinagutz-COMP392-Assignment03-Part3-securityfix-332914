...
var game = (function () {
    ...
    var platform4PhysicsMaterial;
    var platform4Geometry;
    var platform4Material;
    var platform4;
    var platform4Texture;
    var platform5PhysicsMaterial;
    var platform5Geometry;
    var platform5Material;
    var platform5;
    var platform5Texture;
    //Player object
    var playerGeometry;
    var playerMaterial;
    var player;
    ...
    function init() {
        ...
        //Road Two
        road2Geometry = new BoxGeometry(2.5, 4, 100);
